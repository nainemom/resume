    ...
    <div className={cx('flex flex-col gap-y-4 items-start', props.className)}>
      {
        props.experiences.map((experience) => (
          <div
            ...
            className="border-r-4 px-3 py-1 border-r-black w-full space-y-2"
          >
            <div>
            ...
            <Markdown className="text-zinc-800 text-base col-span-2 pt-2">{ experience.role.description }</Markdown>
          </div>
        ))
      }
    </div>
